...
function cfstream_wp_activate() { 
  ...
  if(empty($check_page_exist)) {
      ...
      update_option('cfstream_channel_page_id', $page_id);
  }
}
register_activation_hook( __FILE__, 'cfstream_wp_activate' );